...
class ViewModelFactory(private val app: InterceptXApp) : ViewModelProvider.Factory {
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T = when (modelClass) {
        DashboardViewModel::class.java -> DashboardViewModel(app.applicationContext, app.repository, app.proxyEngine) as T
        InterceptViewModel::class.java -> InterceptViewModel(app.repository, app.interceptQueue, app.proxyEngine) as T
